...
@test "includes standard labels" {
  ...
  assert_contains "$manifest" 'kaptain.org/version: "${Version}"'
  assert_contains "$manifest" 'kaptain.org/project-name: "${ProjectName}"'
  assert_contains "$manifest" 'kaptain.org/owner: "kube-kaptain"'
}
...
@test "includes kaptain annotations" {
  ...
  assert_contains "$manifest" 'kaptain.org/project-name: "${ProjectName}"'
  assert_contains "$manifest" 'kaptain.org/version: "${Version}"'
  assert_contains "$manifest" "kaptain.org/build-timestamp:"
  assert_contains "$manifest" 'kaptain.org/generated-by: "Generated by Kaptain generate-kubernetes-workload-deployment"'
  ...
  assert_contains "$manifest" 'kaptain.org/image-uri: "ghcr.io/kube-kaptain/test-project:1.0.0"'
